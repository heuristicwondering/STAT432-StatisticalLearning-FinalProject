...
```{r network1, echo=FALSE, out.width="200px", fig.align="center", fig.cap="Network generated for InfOwnPos connectivity"}
knitr::include_graphics("./images/infownpos.png")
```

```{r network2, echo=FALSE, out.width="200px", fig.align="center", fig.cap="Network generated for EmoLabelNeg connectivity"}
knitr::include_graphics("./images/emolabneg.png")
```
...
# Discussion
Although no method performed particularly well, there were some winners and losers. SVM and Random Forests should not be used to classify imaging data as they performed by far the worst. PCA decomposition, although not stellar, provided slightly better results. Graph theoretic measures did not perform substantially better but it is entirely plausible that the particular graph meterics were not well suited and therefore we recommend that this area recieve more exploration to assess its importance.
