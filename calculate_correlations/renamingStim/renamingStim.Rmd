...
ShiftVarNames <- function(stimuli){
  ...
  # Assigning indicator values to peaks
  maxStim = apply(design, MARGIN = 1, max)
...
for(d in childdirs){
  ...
  all.files[!file.info(all.files)$isdir] # just in case someone put a directory in here
...
Convolving with a cananonical HRF
```{r hrfdef}
